 ...
 ***/
package com.airhockey.android.touch;
...
import com.airhockey.android.common.util.Geometry;
import com.airhockey.android.common.util.Geometry.Plane;
import com.airhockey.android.common.util.Geometry.Point;
import com.airhockey.android.common.util.Geometry.Ray;
import com.airhockey.android.common.util.Geometry.Sphere;
import com.airhockey.android.common.util.Geometry.Vector;
...
public class AirHockeyTouchRenderer implements Renderer {
    ...
    public AirHockeyTouchRenderer(Context context) {
    ...
    public void handleTouchDrag(float normalizedX, float normalizedY) {
        ...
        if (malletPressed) {
            ...
            // Clamp to bounds
            float x = clamp(touchedPoint.x,
                    leftBound + mallet.radius,
                    rightBound - mallet.radius);
            float y = mallet.height / 2f;
            float z = clamp(touchedPoint.z,
                    0f + mallet.radius,
                    nearBound - mallet.radius);
            blueMalletPosition = new Point(x, y, z);
