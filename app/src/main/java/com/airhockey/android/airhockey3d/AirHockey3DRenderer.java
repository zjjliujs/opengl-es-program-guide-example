 ...
 ***/
package com.airhockey.android.airhockey3d;
...
public class AirHockey3DRenderer implements Renderer {
    ...
    private final float[] projectionModelMatrix = new float[16];
    ...
    public void onSurfaceChanged(GL10 glUnused, int width, int height) {
        ...
        multiplyMM(projectionModelMatrix, 0, projectionMatrix, 0, modelMatrix, 0);
        //System.arraycopy(projectionModelMatrix, 0, projectionMatrix, 0, projectionModelMatrix.length);
    }
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        // Assign the matrix
        glUniformMatrix4fv(uMatrixLocation, 1, false, projectionModelMatrix, 0);
