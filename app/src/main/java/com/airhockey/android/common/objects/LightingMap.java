...
import com.airhockey.android.common.data.IndexBuffer;
import com.airhockey.android.common.data.VertexBuffer;
...
public class LightingMap {
    ...
    public LightingMap(Bitmap bitmap) {
    ...
    public void bindData(LightingShaderProgram heightmapProgram) {
