...
import com.airhockey.android.common.util.Geometry.Circle;
...
class ObjectBuilder {
    ...
    static GeneratedData createPuck(Cylinder puckCylinder, int numPoints) {
        ...
        Circle puckTop = new Circle(
                puckCylinder.center.translateY(puckCylinder.height / 2f),
                puckCylinder.radius);

        builder.appendCircle(puckTop, numPoints);
        builder.appendOpenCylinder(puckCylinder, numPoints);
