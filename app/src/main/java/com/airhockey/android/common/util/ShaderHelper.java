...
public class ShaderHelper {
    ...
    private static int compileShader(int type, String shaderCode) {
        ...
        if (shaderObjectId == 0) {
            if (LoggerConfig.ON) {
                logWarn("Could not create new shader.");
            }
        ...
        if (LoggerConfig.ON) {
            ...
            logVerbose("Results of compiling source:\n" + shaderCode
        ...
        if (compileStatus[0] == 0) {
            ...
            if (LoggerConfig.ON) {
                logWarn("Compilation of shader failed.");
            }
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (programObjectId == 0) {
            if (LoggerConfig.ON) {
                logWarn("Could not create new program");
            }
        ...
        if (LoggerConfig.ON) {
            ...
            logVerbose("Results of linking program:\n"
        ...
        if (linkStatus[0] == 0) {
            ...
            if (LoggerConfig.ON) {
                logWarn("Linking of program failed.");
            }
            return 0;
        }
    ...
    public static boolean validateProgram(int programObjectId) {
        ...
        logVerbose("Results of validating program: " + validateStatus[0]
