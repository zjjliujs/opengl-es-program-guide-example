...
package com.airhockey.android.particles;
...
import com.airhockey.android.common.objects.ParticleFireworksExplosion;
...
public class ParticlesRenderer implements Renderer {
    ...
    private int texture;
    private ParticleFireworksExplosion fireworksExploder;
    ...
    public void onSurfaceChanged(GL10 glUnused, int width, int height) {
        ...
        translateM(viewMatrix, 0, 0f, -1.6f, -5f);
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        //fireworksExploder.addExplosion(particleSystem, new Point(0f, 0.5f, 0), 0xffff0000, System.nanoTime());
